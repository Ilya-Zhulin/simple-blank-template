...
<div uk-grid class="uk-child-width-1-1 <?php echo $patternclass; ?>">
	<?php include_once JPATH_THEMES . '/simple_blank/includes/layouts/section/' . $html_prefix . 'top.php'; ?>
	<div>
		<div uk-grid>
				...
				<div uk-grid class="uk-child-width-1-1">
					<?php if (${'sb1_' . $var_prefix . 'exist'} && ${'sb1_' . $var_prefix . 'position'} == 1) { ?>
						<div class="<?php echo $html_prefix; ?>sidebar-a-wrapper left-<?php echo $html_prefix; ?>sidebar-wrapper uk-width-<?php echo $fraction(${'sb1_' . $var_prefix . 'real_width'}); ?>@s">
							<?php include_once JPATH_THEMES . '/simple_blank/includes/layouts/section/' . $html_prefix . 'sidebar-a.php'; ?>
						</div>
					<?php } ?>
					<div class="uk-width-<?php echo ${$var_prefix . 'content_width'}; ?>">
						<?php include_once JPATH_THEMES . '/simple_blank/includes/layouts/section/' . $html_prefix . 'main.php'; ?>
					</div>
					...
					<?php } ?>
					<?php include_once JPATH_THEMES . '/simple_blank/includes/layouts/section/' . $html_prefix . 'bottom.php'; ?>
				</div>
			</div>
