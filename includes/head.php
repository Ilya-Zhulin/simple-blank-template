...
<?php
if (file_exists(JPATH_ROOT . 'path_to_theme_file1')) {
	include_once JPATH_ROOT . 'path_to_theme_file1';
}
if (!JFile::exists(JPATH_ROOT . '/templates/simple_blank/images/favicon/favicon.ico')) {
	?>
...
?>
<?php
if (file_exists(JPATH_ROOT . 'path_to_theme_file2')) {
	include_once JPATH_ROOT . 'path_to_theme_file2';
}
?>