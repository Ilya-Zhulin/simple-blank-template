...
class ScripterField extends FormField
{
    ...
    protected function getInput()
    {
        ...
        if (!empty($params->theme_name) && strlen(trim($params->theme_name)) > 0) {
            $themeName = trim(preg_replace('/[^A-Za-z0-9_-]/', '', $params->theme_name)); // Санитизация имени
            ...
            // Удаляем theme_name из параметров, чтобы не создавать тему повторно при каждом сохранении
            unset($params->theme_name);
