...
<?php if (!$this->raw_rendering) { ?>
	<div <?php echo $id; ?>class="cck_page cck-clrfix"><div>
		...
		if ($this->params->get('show_page_heading')) {
			if (stripos($this->params->get('pageclass_sfx'), 'user-header') !== FALSE) {
				?>
...
//            echo '<h1 class="uk-heading-line uk-text-center"><span>' . ( ( $this->escape($this->params->get('page_heading')) ) ? $this->escape($this->params->get('page_heading')) : $this->escape($this->params->get('page_title')) ) . '</span></h1>';
			...
			} elseif (stripos($this->params->get('pageclass_sfx'), 'big-header') !== FALSE) {
				echo '
<div class="page-header uk-inline">
    ...
    <h1 class="uk-margin-large-top">' . ( ( $this->escape($this->params->get('page_heading')) ) ? $this->escape($this->params->get('page_heading')) : $this->escape($this->params->get('page_title')) ) . '</h1>
            </div></div>';
			} else {
...
<?php } ?>
<?php
if ($this->load_resource && $this->total) {
