...
<div uk-grid>
	<div class="uk-width-auto@m">
		<ul id="tabs-<?php echo $module->id; ?>" class="<?php echo $class_sfx; ?>"<?php
		$tag			 = '';
		if ($params->get('tag_id') != null) {
			$tag = $params->get('tag_id') . '';
			echo ' id="' . $tag . '"';
		}
		?> uk-tab="connect: #tab-content-<?php echo $module->id; ?>;<?php echo htmlspecialchars($params->get('window_open')); ?>">
...
//JBDump($second_level, 0);
	...
	<div class="uk-width-expand@m">
		<ul id="tab-content-<?php echo $module->id; ?>" class="uk-switcher <?php echo $headerClass;
	?>"<?php
			$tag = '';
			if ($params->get('tag_id') != null) {
				$tag = $params->get('tag_id') . '';
